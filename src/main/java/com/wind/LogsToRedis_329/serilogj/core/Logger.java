...
import com.wind.LogsToRedis_329.serilogj.ILogger;
import com.wind.LogsToRedis_329.serilogj.core.enrichers.FixedPropertyEnricher;
...
import com.wind.LogsToRedis_329.serilogj.parameters.MessageTemplateProcessorResult;
...
public class Logger implements ILogger, ILogEventSink, Closeable {
	...
	public void close() throws IOException {
		if (closeSink && sink instanceof Closeable) {
